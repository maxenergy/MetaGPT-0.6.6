...
text
{tasks}
{code_blocks} # This should include the C++ code blocks as needed
...
## TODOs: List the files that need to be modified along with the reasons in a structured format (e.g., JSON, Python dict, C++ map, etc.), based on the language of the code being reviewed. We will modify them later.
"""
...
Save to grepper
Summary
file1.cpp: 需要添加 xxx 功能...
file2.cpp: 需要修复 yyy 错误...
file3.cpp: 优化 zzz 性能...
...
TODOs
{
...
class SummarizeCode(Action):
    ...
    async def run(self):
        ...
        for filename in self.context.codes_filenames:
            ...
            lang_tag = "cpp" if file_extension == "cpp" else "python"  # 可根据需要增加更多语言支持

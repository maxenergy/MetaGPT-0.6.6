...
class TeachingPlanBlock:
    ...
    TOPIC_STATEMENTS = {
        ...
        "C++ Basics": [
            'Statement: Explain the basic syntax and structure of C++ programming language. Include key concepts such as variables, data types, and basic I/O operations.',
            'Statement: Provide simple example codes to demonstrate the syntax and basic operations in C++.'
        ],
        "C++ Advanced Features": [
            'Statement: Discuss advanced features of C++ like Object-Oriented Programming, pointers, and memory management.',
            'Statement: Include examples that show how to use these advanced features effectively.'
        ],
        "C++ Programming Exercises": [
            'Statement: Create exercises to practice C++ programming. Include tasks that involve writing functions, solving logical problems, and manipulating data structures.'
        ],
    }

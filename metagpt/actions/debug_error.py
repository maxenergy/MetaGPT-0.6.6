...
then rewrite the development code or the test code in C++ based on your role, the error, and the summary, such that all bugs are fixed and the code performs well.
...
```
---
Now you should start rewriting the code in C++:

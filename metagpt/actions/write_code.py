...
Set default value: If there is any setting, ALWAYS SET A DEFAULT VALUE, ALWAYS USE STRONG TYPE AND EXPLICIT VARIABLE. AVOID circular import.
...
Before using an external variable/module, make sure you import it first.
Write out EVERY CODE DETAIL, DON'T LEAVE TODO.
"""
...
class WriteCode(Action):
    ...
    async def run(self, *args, **kwargs) -> CodingContext:
        ...
        code_language = Path(self.context.filename).suffix[1:]  # 获取文件扩展名
        lang_tag = "cpp" if code_language == "cpp" else "python"  # 也可根据需要增加其他语言
